...
### High-Level Workflow
1.  **Data Ingestion:** The system ingests structured (CSV, Excel) and unstructured (PDF, Images) financial data from a drive storage bucket. A **Data Ingestion Agent** handles parsing, schema mapping, and OCR extraction.
